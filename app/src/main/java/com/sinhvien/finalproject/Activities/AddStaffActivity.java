...
public class AddStaffActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffid= getIntent().getIntExtra("staffid",0);   //lấy manv từ display staff
        if(staffid != 0){
            ...
            //Display gender from database
            String gioitinh = staffDTO.getSEX();
            if(gioitinh.equals("Femal")){
            ...
            //Display date of birth from database
    ...
    public void onClick(View v) {
        ...
        switch (id){
            case R.id.btn_addstaff_Addstaff:
                ...
                sEx = DT_addstaff_Dateofbirth.getDayOfMonth() + "/" + (DT_addstaff_Dateofbirth.getMonth() + 1)
