...
public class Register2ndActivity extends AppCompatActivity {
    ...
    String fullname,Username,eMail,phone,password,sEx;
    StaffDAO staffDAO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get data from register1's bundle
        ...
        BTN_signup_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Dateofbirth = DT_signup_Dayofbirth.getDayOfMonth() + "/" + (DT_signup_Dayofbirth.getMonth() + 1)
