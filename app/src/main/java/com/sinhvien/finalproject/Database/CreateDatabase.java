...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public static String TBL_TABLE = "TABLE";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tblTABLE = "CREATE TABLE " +TBL_TABLE+ " ( " +TBL_TABLE_TABLEID+ " INTEGER PRIMARY KEY AUTOINCREMENT, "
                +TBL_TABLE_TABLENAME+ " TEXT, " +TBL_FOOD_STATUS+ " TEXT )";
        ...
        String tblORDER = "CREATE TABLE " +TBL_ORDER+ " ( " +TBL_ORDER_ORDERID+ " INTEGER PRIMARY KEY AUTOINCREMENT, "
                +TBL_ORDER_TABLEID+ " INTEGER, " +TBL_ORDER_STAFFID+ " INTEGER, " +TBL_ORDER_ORDERDATE+ " TEXT, "+TBL_ORDER_TOTAL+" TEXT,"
                +TBL_ORDER_STATUS+ " TEXT )" ;
