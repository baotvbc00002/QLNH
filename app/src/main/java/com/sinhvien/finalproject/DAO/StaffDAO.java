...
//        {
//            while (!cursor.isAfterLast()){
//                if(cursor.getColumnIndex(CreateDatabase.TBL_STAFF_USERNAME)>=0)
//                    username+= cursor.getString(cursor.getColumnIndex(CreateDatabase.TBL_STAFF_USERNAME));
//                else
//                    username+="errrrr";
//            }
//            return username;
